...
export class ListingsAllPropertyComponent implements OnInit {
  ...
  constructor(private router: Router , private service: ResidentAllPropertylistingService ,breakpointObserver: BreakpointObserver) {
