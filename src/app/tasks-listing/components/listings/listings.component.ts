...
export class ListingsComponent implements OnInit {
  ...
  displayedColumns = ['service_name', 'first_name', 'property_name', 'captain','service_completed','created_at','user_profile_service_day'];
  allResidentUsers = [];
  allbuilding = [];
  allbuildingfilter = [];
  allTasks: any;
...
constructor(private router: Router, breakpointObserver: BreakpointObserver, private service: TasksService) {
  ...
  $('.page-title').text('Tasks This Week');
